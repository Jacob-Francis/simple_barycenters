...
# fig_ex.savefig('/home/jjf817/PhD_jobs/simple_barycentres/spread_curves/grp10/grp10_bary_ex_rho1_kl.png', bbox_inches='tight', dpi=200)
# plt.close()
...
# fig_ex.savefig('/home/jjf817/PhD_jobs/simple_barycentres/spread_curves/grp10/grp10_ellipsebary_ex_rho1_kl.png', bbox_inches='tight', dpi=200)
...
fig_ss, ax_ss = plt.subplots(1, 2, figsize=(18, 8))

for data_set in [21, 22]:
...
fig_ss.savefig(f'spread_curves/grp10/grp10_ss_2122_rho{rho}.png', dpi=200, bbox_inches='tight')
...
fig_ss.savefig(f'spread_curves/grp10/grp10_ss_decomp_2122_rho{rho}.png', dpi=200, bbox_inches='tight')
