...
fig_ex.savefig('/home/jjf817/PhD_jobs/simple_barycentres/spread_curves/grp1/grp1_bary_ex_rho1_kl.png', bbox_inches='tight', dpi=200)
plt.close()
...
fig_ex.savefig('/home/jjf817/PhD_jobs/simple_barycentres/spread_curves/grp1/grp1_ellipsebary_ex_rho1_kl.png', bbox_inches='tight', dpi=200)
...
legend_elements = [
            ...
            Line2D([0], [0],
                color='black', linestyle=line_style[3],
                label='Set3'
            ),
            Line2D([0], [0],
                color='black', linestyle=line_style[4],
                label='Set4'
            ),
        ]
...
fig_ss.savefig(f'spread_curves/grp1/grp1_ss_34_rho{rho}.png', dpi=200, bbox_inches='tight')
