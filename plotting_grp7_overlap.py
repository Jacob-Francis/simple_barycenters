...
data_sets = [11, 12, 13, 14] # 10 desn't run 7?
...
try:
    fig_1.savefig(f'spread_curves/group7/grp7_se_vary_eps{str(epsilon)[2:]}.png', dpi=200, bbox_inches="tight")
    
# if not folder dataset exists, create it and save
except FileNotFoundError:
    import os
    os.makedirs(f'spread_curves/group7', exist_ok=True)
    fig_1.savefig(f'spread_curves/group7/grp7_se_vary_eps{str(epsilon)[2:]}_rho{rho}.png', dpi=200, bbox_inches="tight")

fig_2.savefig(f'spread_curves/group7/grp7_se_sprea_skill_eps{str(epsilon)[2:]}_rho{rho}.png', dpi=200, bbox_inches="tight")

fig_decomp.savefig(f'spread_curves/group7/grp7_se_spread_decomp_eps{str(epsilon)[2:]}_rho{rho}.png', dpi=200, bbox_inches="tight")
