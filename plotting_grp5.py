...
fig_ss, ax_ss_all = plt.subplots(1, 4, figsize=(28, 6))
...
# fig_ss.savefig(f'spread_curves/grp5/grp5_ss_5_allrho.png', dpi=200, bbox_inches='tight')
...
fig_ss.savefig(f'spread_curves/grp5/grp5_ss_5decomp_allrho.png', dpi=200, bbox_inches='tight')
